...
function App() {
  ...
  var _useState21 = (0,react.useState)('Kom ihåg orden på skärmen. När tiden är ute skriver du orden i rutorna som visas på skärmen. Om du vill kan du visa svarsrutorna direkt genom att trycka på stoppursbilden.'),
  ...
  var _useState25 = (0,react.useState)('Börja spelet'),
  ...
  var getDataPath = function getDataPath() {
    ...
    if (true) return 'https://lusi-dataviz.ylestatic.fi/2019_minnesspel/assets/data';
    return 'assets/data';
  };
  (0,react.useEffect)(function () {
    fetch("".concat(getDataPath(), "/2019_minnesspel_data.json")).then(function (response) {
      if (!response.ok) {
  ...
  var checkWords = function checkWords() {
    ...
    var values_correct = [];
    index_default.each(document.querySelectorAll('#app-root-2019_minnesspel .inputs'), function (element) {
    ...
    if (allow_to_continue === true) {
      ...
      setHiddenNextButton(false);
      setHiddenReadyButton(true);
      setInfoText("Du kom till niv\xE5 ".concat(round + 1, "!"));
      setRound(round + 1);
      setStartText('Fortsätt');
    } else {
      var url = 'https://svenska.yle.fi/a/7-1412320';
      setFacebookLink("https://www.facebook.com/sharer/sharer.php?u=".concat(encodeURIComponent("https://share.api.yle.fi/share/minnesspel/taso_".concat(round, ".html?url=").concat(url.replace('https://svenska.yle.fi/', '')))));
      setHiddenInfo(false);
      setHiddenReadyButton(true);
      setHiddenRestartButton(false);
      setInfoText("\xC4sch, ".concat(incorrect_count, " gick fel och spelet tog slut. Du kom till niv\xE5 ").concat(round, "!"));
      setTwitterLink("https://twitter.com/share?url=".concat(url, "&hashtags=").concat(encodeURIComponent('vetamix,yle,minnesspel'), "&text=").concat(encodeURIComponent("Jag kom till niv\xE5  ".concat(round, "!  i Vetamix minnestest. Testa hur bra du kommer ih\xE5g ord."))));
    }
  };
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "app"
  }, /*#__PURE__*/react.createElement("h2", null, "Minnesspel"), /*#__PURE__*/react.createElement("div", {
    ...
    type: "button"
  }, "Svara"), !hiddenTimer && /*#__PURE__*/react.createElement("button", {
  ...
  }, "Dela resultatet p\xE5", ' ', /*#__PURE__*/react.createElement("a", {
    href: twitterLink,
    target: "_blank",
    ...
    rel: "noreferrer"
  }, "Twitter"), ' ', "ja", ' ', /*#__PURE__*/react.createElement("a", {
    href: facebookLink,
    target: "_blank",
    onClick: function onClick(event) {
      return shareButton(event);
    ...
    rel: "noreferrer"
  }, "Facebook"), "."), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("button", {
    className: "button",
    onClick: function onClick() {
      return reset();
    },
    type: "button"
  }, "Spela en g\xE5ng till!"))));
}
